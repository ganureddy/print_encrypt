...
class Notification(Document):
    ...
    if TYPE_CHECKING:
        ...
        custom_password_policy: DF.Data | None
        custom_encrypt_print: DF.Check
...
"""
    ...
    def get_attachment(self, doc,context=None):
        ...
        if (doc.docstatus == 0 and not print_settings.allow_print_for_draft) or (
            ...
            if self.custom_encrypt_print:
                get_password = frappe.render_template(self.custom_password_policy, context)
                return [
                    {
